...
public class AliyunOSSClientUtils {
	...
	// accessKey
	private String accessKeyId = "LTAI4FquVcTa1JmY21mowfuK";
	private String accessKeySecret = "I7kjW4OgLAUZBEALn3ja5hjQdAV0Tt";
	// 空间
	private String bucketName = "meinvhonghong";
	// 文件存储目录
